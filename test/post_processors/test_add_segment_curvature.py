...
def test_straight():
    ...
    assert result[0][0]['segments'][0]['curvature'] == 0
...
def test_level_1():
    ...
    assert result[0][0]['segments'][0]['curvature'] == 10
...
def test_level_2():
    ...
    assert result[0][0]['segments'][0]['curvature'] == 13
...
def test_level_3():
    ...
    assert result[0][0]['segments'][0]['curvature'] == 16
...
def test_level_4():
    ...
    assert result[0][0]['segments'][0]['curvature'] == 20
